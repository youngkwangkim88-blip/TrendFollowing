...
def bake_data():
    print(f"[Stage6 Step1] Data baking start (window={WINDOW_SIZE})")
    ...
    os.makedirs("data/stage6", exist_ok=True)
    np.savez_compressed(
        "data/stage6/baked_dataset_h110.npz",
    ...
    print("Saved: data/stage6/baked_dataset_h110.npz")
